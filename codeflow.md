# Create following DB collections for hotel:
...
* [Created DB HotelBooking online at Atlas MongoDB](https://cloud.mongodb.com/v2/5ef4437625a411434fb7c154#clusters/connect?clusterId=Cluster0)

* Connect to Db Using MongoDB native drivers 

    ![MongoDB Connection](./public/MongoDbConnect.PNG "MongoDB Connection")

* Select node as Driver and latest version

    ![MongoDB Connection code](./public/mongoconnect_code.PNG "MongoDB Connection")


```
    
const MongoClient = require('mongodb').MongoClient;
const uri = "mongodb+srv://admin:<password>@cluster0.bn8gj.mongodb.net/<dbname>?retryWrites=true&w=majority";
